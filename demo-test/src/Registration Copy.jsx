...
export default function RegisterPage() {
  ...
  return (
    <div className="all">
    <div className="flex" style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100vh"}}>
      <Card className="card-container" style={{ width: "400px", padding: "20px", boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.1)" }}>
        <CardContent>
          ...
          <Typography variant="body2" align="center" mt={2}>
            Уже есть аккаунт? <Link to="/registration" style={{ color: "#1976d2" }}>Войти</Link>
          </Typography>
        </CardContent>
      </Card>
    </div>
