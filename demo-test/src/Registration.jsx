...
export default function RegisterPage() {
  ...
  return (
    ...
    <div className="flex" style = {{ height: '100vh', justifyContent: 'center', padding: '0', margin: '0'}}>
      <Card className="card-container" style = {{ overflow: 'visible' }}>
        <CardContent>
          ...
          Уже есть аккаунт? <Link to="/login" style={{ color: "#361087" }}>Войти</Link>
          </Typography>
        </CardContent>
      </Card>
    </div>
